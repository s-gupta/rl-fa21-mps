...
def main():
    ...
    # you are happy with the performance of your model, you should upload the predictions
    # generated below to the autograder to be evaluated against the test set.
    simple_val(model, 'val', device)
    ...
    # Produce predictions on test set for upload to autograder
    test_prefix_strings = torch.load('data/arXiv/test_prefix_strings.torch')
    UNK = string.printable.index(' ')
    prefix_inds = []
